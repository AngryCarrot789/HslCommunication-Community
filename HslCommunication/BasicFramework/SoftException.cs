...
public sealed class Exception<TExceptionArgs> : Exception, ISerializable where TExceptionArgs : ExceptionArgs {
    ...
    /// 消息
    /// </summary>
    public TExceptionArgs Args { get { return this.m_args; } }
    ...
    private Exception(SerializationInfo info, StreamingContext context) : base(info, context) {
        this.m_args = (TExceptionArgs) info.GetValue(c_args, typeof(TExceptionArgs));
    }
    ...
    public override void GetObjectData(SerializationInfo info, StreamingContext context) {
        info.AddValue(c_args, this.m_args);
    ...
    public override string Message {
        get {
            ...
            return this.m_args == null ? baseMsg : baseMsg + " (" + this.m_args.Message + ")";
        }
    }
    ...
    public override bool Equals(object obj) {
        ...
        if (other == null)
            return false;
        return Equals(this.m_args, other.m_args) && base.Equals(obj);
    }
