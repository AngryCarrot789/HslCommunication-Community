...
public class SoftMail {
    ...
    /// </remarks>
    /// <example>
    /// <code lang="cs" source="HslCommunication\BasicFramework\SoftMail.cs" region="Static Mail" title="SoftMail示例" />
    /// </example>
    ...
    public bool SendMail(string addr_to, string subject, string body, bool isHtml) {
        return this.SendMail(this.MailFromAddress, StringResources.Language.MailServerCenter, new string[] { addr_to }, subject, body, MailPriority.Normal, isHtml);
    }
