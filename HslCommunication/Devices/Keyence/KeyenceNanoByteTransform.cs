...
public class KeyenceNanoByteTransform : IByteTransform {
    ...
    public virtual bool TransBool(byte[] buffer, int index) {
        return this.BytesToStringArray(buffer)[index] == "1" ? true : false;
    }
    ...
    public bool[] TransBool(byte[] buffer, int index, int length) {
        ...
        for (int i = 0; i < length; i++) {
            result[i] = this.BytesToStringArray(buffer)[index + i] == "1" ? true : false;
        }
    ...
    public virtual byte TransByte(byte[] buffer, int index) {
        return Convert.ToByte(this.BytesToStringArray(buffer)[index]);
    }
    ...
    public virtual byte[] TransByte(byte[] buffer, int index, int length) {
        ...
        for (int i = 0; i < length; i++) {
            result[i] = Convert.ToByte(this.BytesToStringArray(buffer)[index + i]);
        }
    ...
    public virtual short TransInt16(byte[] buffer, int index) {
        return Convert.ToInt16(this.BytesToStringArray(buffer)[index]);
    }
    ...
    public virtual short[] TransInt16(byte[] buffer, int index, int length) {
        ...
        for (int i = 0; i < length; i++) {
            result[i] = Convert.ToInt16(this.BytesToStringArray(buffer)[i + index]);
        }
    ...
    public virtual ushort TransUInt16(byte[] buffer, int index) {
        return Convert.ToUInt16(this.BytesToStringArray(buffer)[index]);
    }
    ...
    public virtual ushort[] TransUInt16(byte[] buffer, int index, int length) {
        ...
        for (int i = 0; i < length; i++) {
            result[i] = Convert.ToUInt16(this.BytesToStringArray(buffer)[i + index]);
        }
    ...
    public virtual int TransInt32(byte[] buffer, int index) {
        return Convert.ToInt32(this.BytesToStringArray(buffer)[index]);
    }
    ...
    public virtual int[] TransInt32(byte[] buffer, int index, int length) {
        ...
        for (int i = 0; i < length; i++) {
            result[i] = Convert.ToInt32(this.BytesToStringArray(buffer)[i + index]);
        }
    ...
    public virtual uint TransUInt32(byte[] buffer, int index) {
        return Convert.ToUInt32(this.BytesToStringArray(buffer)[index]);
    }
    ...
    public virtual uint[] TransUInt32(byte[] buffer, int index, int length) {
        ...
        for (int i = 0; i < length; i++) {
            result[i] = Convert.ToUInt32(this.BytesToStringArray(buffer)[i + index]);
        }
    ...
    public virtual long TransInt64(byte[] buffer, int index) {
        return Convert.ToInt64(this.BytesToStringArray(buffer)[index]);
    }
    ...
    public virtual long[] TransInt64(byte[] buffer, int index, int length) {
        ...
        for (int i = 0; i < length; i++) {
            result[i] = Convert.ToInt64(this.BytesToStringArray(buffer)[i + index]);
        }
    ...
    public virtual ulong TransUInt64(byte[] buffer, int index) {
        return Convert.ToUInt64(this.BytesToStringArray(buffer)[index]);
    }
    ...
    public virtual ulong[] TransUInt64(byte[] buffer, int index, int length) {
        ...
        for (int i = 0; i < length; i++) {
            result[i] = Convert.ToUInt64(this.BytesToStringArray(buffer)[i + index]);
        }
    ...
    public virtual float TransSingle(byte[] buffer, int index) {
        return Convert.ToSingle(this.BytesToStringArray(buffer)[index]);
    }
    ...
    public virtual float[] TransSingle(byte[] buffer, int index, int length) {
        ...
        for (int i = 0; i < length; i++) {
            result[i] = Convert.ToSingle(this.BytesToStringArray(buffer)[i + index]);
        }
    ...
    public virtual double TransDouble(byte[] buffer, int index) {
        return Convert.ToDouble(this.BytesToStringArray(buffer)[index]);
    }
    ...
    public virtual double[] TransDouble(byte[] buffer, int index, int length) {
        ...
        for (int i = 0; i < length; i++) {
            result[i] = Convert.ToDouble(this.BytesToStringArray(buffer)[i + index]);
        }
    ...
    public virtual byte[] TransByte(bool value) {
        return this.TransByte(new bool[] { value });
    }
    ...
    public virtual byte[] TransByte(ushort value) {
        return this.TransByte(new ushort[] { value });
    }
    ...
    public virtual byte[] TransByte(uint value) {
        return this.TransByte(new uint[] { value });
    }
    ...
    public virtual byte[] TransByte(ulong value) {
        return this.TransByte(new ulong[] { value });
    }
        ...
        public static byte[] ToBytes(T[] values, string dataFormat) {
            ...
            for (int i = 0; i < values.Length; i++) {
                ...
                if (typeof(T) == typeof(int)) {
                    ...
                    uint value = Convert.ToUInt32(values[i]);
                    stringBuilder.Append(value.ToString());
                }
                else if (typeof(T) == typeof(short)) {
                    short value = Convert.ToInt16(values[i]);
                    stringBuilder.Append(value.ToString());
                }
                else if (typeof(T) == typeof(ushort)) {
                    ushort value = Convert.ToUInt16(values[i]);
                    stringBuilder.Append(value.ToString());
                }
                    ...
                    ulong value = Convert.ToUInt64(values[i]);
                    stringBuilder.Append(value.ToString());
                }
