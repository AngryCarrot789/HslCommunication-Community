...
public class MelsecMcDataType {
    ...
    /// 定时器的当前值
    /// </summary>
    public static readonly MelsecMcDataType TN = new MelsecMcDataType(0xC2, 0x00, "TN", 10);

    /// <summary>
    /// 定时器的触点
    /// </summary>
    public static readonly MelsecMcDataType TS = new MelsecMcDataType(0xC1, 0x01, "TS", 10);

    /// <summary>
    /// 定时器的线圈
    /// </summary>
    public static readonly MelsecMcDataType TC = new MelsecMcDataType(0xC0, 0x01, "TC", 10);

    /// <summary>
    /// 累计定时器的触点
    /// </summary>
    public static readonly MelsecMcDataType SS = new MelsecMcDataType(0xC7, 0x01, "SS", 10);

    /// <summary>
    /// 累计定时器的线圈
    /// </summary>
    public static readonly MelsecMcDataType SC = new MelsecMcDataType(0xC6, 0x01, "SC", 10);

    /// <summary>
    /// 累计定时器的当前值
    /// </summary>
    public static readonly MelsecMcDataType SN = new MelsecMcDataType(0xC8, 0x00, "SN", 100);

    /// <summary>
    /// 计数器的当前值
    /// </summary>
    public static readonly MelsecMcDataType CN = new MelsecMcDataType(0xC5, 0x00, "CN", 10);

    /// <summary>
    /// 计数器的触点
    /// </summary>
    public static readonly MelsecMcDataType CS = new MelsecMcDataType(0xC4, 0x01, "CS", 10);

    /// <summary>
    /// 计数器的线圈
    /// </summary>
    public static readonly MelsecMcDataType CC = new MelsecMcDataType(0xC3, 0x01, "CC", 10);
    ...
    /// 控制继电器
    /// </summary>
    public static readonly MelsecMcDataType Keyence_SM = new MelsecMcDataType(0x91, 0x01, "SM", 10);

    /// <summary>
    /// 控制存储器
    /// </summary>
    public static readonly MelsecMcDataType Keyence_SD = new MelsecMcDataType(0xA9, 0x00, "SD", 10);
    ...
    /// 文件寄存器
    /// </summary>
    public static readonly MelsecMcDataType Keyence_ZR = new MelsecMcDataType(0xB0, 0x00, "ZR", 16);
    ...
    /// 计时器（当前值）
    /// </summary>
    public static readonly MelsecMcDataType Keyence_TN = new MelsecMcDataType(0xC2, 0x00, "TN", 10);

    /// <summary>
    /// 计时器（接点）
    /// </summary>
    public static readonly MelsecMcDataType Keyence_TS = new MelsecMcDataType(0xC1, 0x01, "TS", 10);

    /// <summary>
    /// 计数器（当前值）
    /// </summary>
    public static readonly MelsecMcDataType Keyence_CN = new MelsecMcDataType(0xC5, 0x00, "CN", 10);

    /// <summary>
    /// 计数器（接点）
    /// </summary>
    public static readonly MelsecMcDataType Keyence_CS = new MelsecMcDataType(0xC4, 0x01, "CS", 10);
    ...
    /// 计时器（当前值）
    /// </summary>
    public static readonly MelsecMcDataType Panasonic_TN = new MelsecMcDataType(0xC2, 0x00, "TN", 10);

    /// <summary>
    /// 计时器（接点）
    /// </summary>
    public static readonly MelsecMcDataType Panasonic_TS = new MelsecMcDataType(0xC1, 0x01, "TS", 10);

    /// <summary>
    /// 计数器（当前值）
    /// </summary>
    public static readonly MelsecMcDataType Panasonic_CN = new MelsecMcDataType(0xC5, 0x00, "CN", 10);

    /// <summary>
    /// 计数器（接点）
    /// </summary>
    public static readonly MelsecMcDataType Panasonic_CS = new MelsecMcDataType(0xC4, 0x01, "CS", 10);

    /// <summary>
    /// 特殊链接继电器
    /// </summary>
    public static readonly MelsecMcDataType Panasonic_SM = new MelsecMcDataType(0x91, 0x01, "SM", 10);

    /// <summary>
    /// 特殊链接存储器
    /// </summary>
    public static readonly MelsecMcDataType Panasonic_SD = new MelsecMcDataType(0xA9, 0x00, "SD", 10);
