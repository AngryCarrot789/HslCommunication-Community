...
namespace HslCommunication.Devices.FATEK;
...
public class FatekProgram : SerialDeviceBase<RegularByteTransform> {
    ...
    public override OperateResult<byte[]> Read(string address, ushort length) {
        ...
        if (read.Content[5] != 0x30)
            return new OperateResult<byte[]>(read.Content[5], GetErrorDescriptionFromCode((char) read.Content[5]));
    ...
    public override OperateResult<bool[]> ReadBool(string address, ushort length) {
        ...
        if (read.Content[5] != 0x30)
            return new OperateResult<bool[]>(read.Content[5], GetErrorDescriptionFromCode((char) read.Content[5]));
    ...
    public override string ToString() {
        return $"FatekProgram[{this.PortName}:{this.BaudRate}]";
    }
