...
public class RedisClient : NetworkDoubleBase<HslMessage, RegularByteTransform> {
    ...
    protected override OperateResult InitializationOnConnect(Socket socket) {
        if (!string.IsNullOrEmpty(this.password)) {
            ...
            OperateResult<byte[]> read = this.ReadFromCoreServer(socket, command);
            if (!read.IsSuccess)
    ...
    /// <code lang="cs" source="HslCommunication.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="ReadFromCoreServerExample1" title="ReadFromCoreServer示例" />
    /// </example>
    ...
    public OperateResult<string> ReadCustomer(string command) {
        ...
        OperateResult<byte[]> read = this.ReadFromCoreServer(byteCommand);
        if (!read.IsSuccess)
            return OperateResult.CreateFailedResult<string>(read);
    ...
    public OperateResult<int> DeleteKey(string key) {
        return this.DeleteKey(new string[] { key });
    }
    ...
    public OperateResult<int> ExistsKey(string key) {
        return this.OperateNumberFromServer(new string[] { "EXISTS", key });
    }
    ...
    public OperateResult<int> ExpireKey(string key) {
        return this.OperateNumberFromServer(new string[] { "EXPIRE", key });
    }
    ...
    public OperateResult<string[]> ReadAllKeys(string pattern) {
        return this.OperateStringsFromServer(new string[] { "KEYS", pattern });
    }
    ...
    public OperateResult MoveKey(string key, int db) {
        return this.OperateStatusFromServer(new string[] { "MOVE", key, db.ToString() });
    }
    ...
    public OperateResult<int> PersistKey(string key) {
        return this.OperateNumberFromServer(new string[] { "PERSIST", key });
    }
    ...
    public OperateResult<string> ReadRandomKey() {
        return this.OperateStringFromServer(new string[] { "RANDOMKEY" });
    }
    ...
    public OperateResult RenameKey(string key1, string key2) {
        return this.OperateStatusFromServer(new string[] { "RENAME", key1, key2 });
    }
    ...
    public OperateResult<int> AppendKey(string key, string value) {
        return this.OperateNumberFromServer(new string[] { "APPEND", key, value });
    }
    ...
    public OperateResult<long> DecrementKey(string key) {
        return this.OperateLongNumberFromServer(new string[] { "DECR", key });
    }
    ...
    public OperateResult<long> DecrementKey(string key, long value) {
        return this.OperateLongNumberFromServer(new string[] { "DECRBY", key, value.ToString() });
    }
    ...
    public OperateResult<string> ReadKey(string key) {
        return this.OperateStringFromServer(new string[] { "GET", key });
    }
    ...
    public OperateResult<string> ReadKeyRange(string key, int start, int end) {
        return this.OperateStringFromServer(new string[] { "GETRANGE", key, start.ToString(), end.ToString() });
    }
    ...
    public OperateResult<string> ReadAndWriteKey(string key, string value) {
        return this.OperateStringFromServer(new string[] { "GETSET", key, value });
    }
    ...
    public OperateResult<long> IncrementKey(string key) {
        return this.OperateLongNumberFromServer(new string[] { "INCR", key });
    }
    ...
    public OperateResult<long> IncrementKey(string key, long value) {
        return this.OperateLongNumberFromServer(new string[] { "INCRBY", key, value.ToString() });
    }
    ...
    public OperateResult<string> IncrementKey(string key, float value) {
        return this.OperateStringFromServer(new string[] { "INCRBYFLOAT", key, value.ToString() });
    }
    ...
    public OperateResult<string[]> ReadKey(string[] keys) {
        ...
        return this.OperateStringsFromServer(list.ToArray());
    }
    ...
    public OperateResult WriteKey(string key, string value) {
        return this.OperateStatusFromServer(new string[] { "SET", key, value });
    }
    ...
    public OperateResult WriteAndPublishKey(string key, string value) {
        OperateResult write = this.WriteKey(key, value);
        if (!write.IsSuccess)
            return write;
    ...
    public OperateResult WriteExpireKey(string key, string value, long seconds) {
        return this.OperateStatusFromServer(new string[] { "SETEX", key, seconds.ToString(), value });
    }
    ...
    public OperateResult<int> WriteKeyIfNotExists(string key, string value) {
        return this.OperateNumberFromServer(new string[] { "SETNX", key, value });
    }
    ...
    public OperateResult<int> WriteKeyRange(string key, string value, int offset) {
        return this.OperateNumberFromServer(new string[] { "SETRANGE", key, offset.ToString(), value });
    }
    ...
    public OperateResult<int> ListInsertBefore(string key, string value, string pivot) {
        return this.OperateNumberFromServer(new string[] { "LINSERT", key, "BEFORE", pivot, value });
    }
    ...
    public OperateResult<int> ListInsertAfter(string key, string value, string pivot) {
        return this.OperateNumberFromServer(new string[] { "LINSERT", key, "AFTER", pivot, value });
    }
    ...
    public OperateResult<int> GetListLength(string key) {
        return this.OperateNumberFromServer(new string[] { "LLEN", key });
    }
    ...
    public OperateResult<string> ReadListByIndex(string key, long index) {
        return this.OperateStringFromServer(new string[] { "LINDEX", key, index.ToString() });
    }
    ...
    public OperateResult<string> ListLeftPop(string key) {
        return this.OperateStringFromServer(new string[] { "LPOP", key });
    }
    ...
    public OperateResult<int> ListLeftPush(string key, string value) {
        return this.ListLeftPush(key, new string[] { value });
    }
    ...
    public OperateResult<int> ListLeftPushX(string key, string value) {
        return this.OperateNumberFromServer(new string[] { "LPUSHX", key, value });
    }
    ...
    public OperateResult<string[]> ListRange(string key, long start, long stop) {
        return this.OperateStringsFromServer(new string[] { "LRANGE", key, start.ToString(), stop.ToString() });
    }
    ...
    public OperateResult<int> ListRemoveElementMatch(string key, long count, string value) {
        return this.OperateNumberFromServer(new string[] { "LREM", key, count.ToString(), value });
    }
    ...
    public OperateResult ListSet(string key, long index, string value) {
        return this.OperateStatusFromServer(new string[] { "LSET", key.ToString(), index.ToString(), value });
    }
    ...
    public OperateResult ListTrim(string key, long start, long end) {
        return this.OperateStatusFromServer(new string[] { "LTRIM", key, start.ToString(), end.ToString() });
    }
    ...
    public OperateResult<string> ListRightPop(string key) {
        return this.OperateStringFromServer(new string[] { "RPOP", key });
    }
    ...
    public OperateResult<string> ListRightPopLeftPush(string key1, string key2) {
        return this.OperateStringFromServer(new string[] { "RPOPLPUSH", key1, key2 });
    }
    ...
    public OperateResult<int> ListRightPush(string key, string value) {
        return this.ListRightPush(key, new string[] { value });
    }
    ...
    public OperateResult<int> DeleteHashKey(string key, string field) {
        return this.DeleteHashKey(key, new string[] { field });
    }
    ...
    public OperateResult<int> ExistsHashKey(string key, string field) {
        return this.OperateNumberFromServer(new string[] { "HEXISTS", key, field });
    }
    ...
    public OperateResult<string> ReadHashKey(string key, string field) {
        return this.OperateStringFromServer(new string[] { "HGET", key, field });
    }
    ...
    public OperateResult<string[]> ReadHashKeyAll(string key) {
        return this.OperateStringsFromServer(new string[] { "HGETALL", key });
    }
    ...
    public OperateResult<long> IncrementHashKey(string key, string field, long value) {
        return this.OperateLongNumberFromServer(new string[] { "HINCRBY", key, field, value.ToString() });
    }
    ...
    public OperateResult<string> IncrementHashKey(string key, string field, float value) {
        return this.OperateStringFromServer(new string[] { "HINCRBYFLOAT", key, field, value.ToString() });
    }
    ...
    public OperateResult<string[]> ReadHashKeys(string key) {
        return this.OperateStringsFromServer(new string[] { "HKEYS", key });
    }
    ...
    public OperateResult<int> ReadHashKeyLength(string key) {
        return this.OperateNumberFromServer(new string[] { "HLEN", key });
    }
    ...
    public OperateResult<int> WriteHashKey(string key, string field, string value) {
        return this.OperateNumberFromServer(new string[] { "HSET", key, field, value });
    }
    ...
    public OperateResult<int> WriteHashKeyNx(string key, string field, string value) {
        return this.OperateNumberFromServer(new string[] { "HSETNX", key, field, value });
    }
    ...
    public OperateResult Save() {
        return this.OperateStatusFromServer(new string[] { "SAVE" });
    }
    ...
    public OperateResult SaveAsync() {
        return this.OperateStatusFromServer(new string[] { "BGSAVE" });
    }
    ...
    public OperateResult<DateTime> ReadServerTime() {
        OperateResult<string[]> times = this.OperateStringsFromServer(new string[] { "TIME" });
        if (!times.IsSuccess)
