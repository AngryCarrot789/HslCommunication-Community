...
public class SoftSettings : HslCommunication.BasicFramework.SoftFileSaveBase {
    ...
    public override string ToSaveString() {
        ...
        element.Add(new System.Xml.Linq.XElement(nameof(this.IpAddress), this.IpAddress));
        element.Add(new System.Xml.Linq.XElement(nameof(this.Port), this.Port.ToString()));
    ...
    public override void LoadByString(string content) {
        ...
        this.IpAddress = element.Element(nameof(this.IpAddress)).Value;
        this.Port = int.Parse(element.Element(nameof(this.Port)).Value);
    }
