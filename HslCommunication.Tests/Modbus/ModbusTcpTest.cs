...
public class ModbusTcpTest {
    ...
    public void ModbusTcpUnitTest() {
        ...
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.WriteCoil(address, true).IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.ReadCoil(address).Content == true);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.WriteCoil(address, boolTmp).IsSuccess);
        ...
        address = "300";
        // short类型
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, (short) 12345).IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.ReadInt16(address).Content == 12345);
        short[] shortTmp = new short[] { 123, 423, -124, 5313, 2361 };
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, shortTmp).IsSuccess);
        ...
        // ushort类型
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, (ushort) 51234).IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.ReadUInt16(address).Content == 51234);
        ushort[] ushortTmp = new ushort[] { 5, 231, 12354, 5313, 12352 };
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, ushortTmp).IsSuccess);
        ...
        // int类型
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, 12342323).IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.ReadInt32(address).Content == 12342323);
        int[] intTmp = new int[] { 123812512, 123534, 976124, -1286742 };
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, intTmp).IsSuccess);
        ...
        // uint类型
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, (uint) 416123237).IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.ReadUInt32(address).Content == (uint) 416123237);
        uint[] uintTmp = new uint[] { 81623123, 91712749, 91273123, 123, 21242, 5324 };
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, uintTmp).IsSuccess);
        ...
        // float类型
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, 123.45f).IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.ReadFloat(address).Content == 123.45f);
        float[] floatTmp = new float[] { 123, 5343, 1.45f, 563.3f, 586.2f };
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, floatTmp).IsSuccess);
        ...
        // double类型
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, 1234.5434d).IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.ReadDouble(address).Content == 1234.5434d);
        double[] doubleTmp = new double[] { 1.4213d, 1223d, 452.5342d, 231.3443d };
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, doubleTmp).IsSuccess);
        ...
        // long类型
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, 123617231235123L).IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.ReadInt64(address).Content == 123617231235123L);
        long[] longTmp = new long[] { 12312313123L, 1234L, 412323812368L, 1237182361238123 };
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, longTmp).IsSuccess);
        ...
        // ulong类型
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, 1283823681236123UL).IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.ReadUInt64(address).Content == 1283823681236123UL);
        ulong[] ulongTmp = new ulong[] { 21316UL, 1231239127323UL, 1238612361283123UL };
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, ulongTmp).IsSuccess);
        ...
        // string类型
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, "123123").IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.ReadString(address, 3).Content == "123123");

        // byte类型
        byte[] byteTmp = new byte[] { 0x4F, 0x12, 0x72, 0xA7, 0x54, 0xB8 };
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(modbus.Write(address, byteTmp).IsSuccess);
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(SoftBasic.IsTwoBytesEquel(modbus.Read(address, 3).Content, byteTmp));
    ...
    public void BuildReadCoilCommandTest() {
        ...
        Microsoft.VisualStudio.TestTools.UnitTesting.Assert.IsTrue(command.IsSuccess, "command create failed");
        ...
        if (command.Content[2] == 0x00 &&
            ...
            Microsoft.VisualStudio.TestTools.UnitTesting.Assert.Fail("command check failed : " + SoftBasic.ByteToHexString(command.Content, ' '));
        }
    }
